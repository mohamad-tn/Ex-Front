...
export class BranchServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateBranchDto | undefined): Observable<BranchDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<BranchDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<BranchDto>(null as any);
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<BranchDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | undefined): Observable<UpdateBranchDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UpdateBranchDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UpdateBranchDto>;
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<UpdateBranchDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UpdateBranchDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<UpdateBranchDto>(null as any);
    }
     ...
     * @return Success
     */
    update(body: UpdateBranchDto | undefined): Observable<BranchDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<BranchDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class IncomeTransferServiceProxy {
     ...
     * @return Success
     */
    getAllIncomeTransfersForBranch(userId: number | undefined): Observable<{ [key: string]: number; }> {
        let url_ = this.baseUrl + "/api/services/app/IncomeTransfer/GetAllIncomeTransfersForBranch?";
        if (userId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllIncomeTransfersForBranch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllIncomeTransfersForBranch(response_ as any);
                } catch (e) {
    ...
    protected processGetAllIncomeTransfersForBranch(response: HttpResponseBase): Observable<{ [key: string]: number; }> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class IncomeTransferDetailServiceProxy {
     ...
     * @return Success
     */
    getDirectTransferForGrid(body: TreasuryCashFlowDataManagerRequest | undefined): Observable<ReadGrudDto> {
...
export class OutgoingTransferServiceProxy {
    ...
    /**
     * @param outgoingTransfer (optional) 
     * @return Success
     */
    rejectOutgoingTransferFromBranchasync(outgoingTransfer: number | undefined): Observable<OutgoingTransferDto> {
        let url_ = this.baseUrl + "/api/services/app/OutgoingTransfer/RejectOutgoingTransferFromBranchasync?";
        if (outgoingTransfer === null)
            throw new Error("The parameter 'outgoingTransfer' cannot be null.");
        else if (outgoingTransfer !== undefined)
            url_ += "outgoingTransfer=" + encodeURIComponent("" + outgoingTransfer) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRejectOutgoingTransferFromBranchasync(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRejectOutgoingTransferFromBranchasync(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<OutgoingTransferDto>;
                }
            } else
    ...
    protected processRejectOutgoingTransferFromBranchasync(response: HttpResponseBase): Observable<OutgoingTransferDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ProvinceServiceProxy {
     ...
     * @return Success
     */
    getProvinceGroup(): Observable<ProvinceGroupDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Province/GetProvinceGroup";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProvinceGroup(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProvinceGroup(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ProvinceGroupDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ProvinceGroupDto[]>;
        }));
    }

    protected processGetProvinceGroup(response: HttpResponseBase): Observable<ProvinceGroupDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(ProvinceGroupDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<ProvinceGroupDto[]>(null as any);
    }
}
...
export class ProvinceGroupDto implements IProvinceGroupDto {
    id: number;
    ...
    constructor(data?: IProvinceGroupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProvinceGroupDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProvinceGroupDto();
        result.init(data);
        return result;
    }
...
export interface IProvinceGroupDto {
    id: number;
    provinceId: string | undefined;
    name: string | undefined;
    group: string | undefined;
